...
To run the model some function arguments need to be specified. The number of time steps to be simulated (n_time) can be interpreted number of years to be simulated. The size of the world needs to be selected as large enought to see the pattern but small enough for your computer. Function argument world_size is the edge length of the world. Other foret
